...
-- -----------------------------------------------------
-- Table `aerolinea`.`Vuelo_has_Combo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `aerolinea`.`Vuelo_has_Combo` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `aerolinea`.`Vuelo_has_Combo` (
  `Vuelo_idVuelo` INT NOT NULL,
  `Combo_idCombo` INT NOT NULL,
  PRIMARY KEY (`Vuelo_idVuelo`, `Combo_idCombo`))
ENGINE = InnoDB;
